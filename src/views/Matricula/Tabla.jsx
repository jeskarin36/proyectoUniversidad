...
function Tabla({alumnos,UsuarioCabeza4,Mandaraeditar,confirmacion,VerDetalle}) {
    console.log(alumnos)
  return (
   
    <>
     {  alumnos.length===0? <td COLSPAN="7"  className='Notfound'><h5>No se Encontraron Datos</h5></td>:alumnos.map((alumno) => (
                  <tr key={alumno.id}>
                    ...
                    <td>{alumno.programa.Nombre}</td>
                 {
                  ...
                  <button onClick={e=>VerDetalle(alumno.id)}><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg></button>
